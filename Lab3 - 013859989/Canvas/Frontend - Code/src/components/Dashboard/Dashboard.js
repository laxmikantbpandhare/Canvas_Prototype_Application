        ...
        return <Redirect to='/Dashboard' />
         ...
         //     console.log('check enroll zala ka book 100');
             ...
             //  console.log("data="+contsa);
               ...
               axios.post('http://'+rooturl+':4000/Dashboard/updateprofile',data, {
          ...
          axios.defaults.withCredentials = true;
                         ...
                         console.log(contsa);
                          ...
                          this.props.client.query({
                            ...
                            console.log('Response', response.data.subjectdetails)//.login.facultyfnd);

                                      this.setState({
                                        tripDetailsForFiltering: response.data.subjectdetails,
                                        courses : response.data.subjectdetails,
                                        books : this.state.books.concat(response.data.subjectdetails)        
                                    })
